  ...
  return (
    <div>
      ...
      <div className="relative h-2 bg-gray-100 rounded-full">
        ...
        {pausePct !== null && (
          <div
            className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-3 h-3 bg-white border-2 border-gray-400 rounded-full z-10"
        ...
        {progressPct > 0 && progressPct < 100 && (
          <div
            className="absolute top-1/2 -translate-y-1/2 -translate-x-1/2 w-2.5 h-2.5 bg-black rounded-full z-20 ring-2 ring-white"
      ...
      <div className="flex justify-between mt-2 text-xs text-gray-400">
        ...
        <span className="font-semibold text-black">{progressPct}% complete</span>
