  ...
  return (
    <div className="max-w-3xl mx-auto px-4 py-20">
      ...
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-6 mb-16">
        {[
          ...
          <div key={f.title} className="card">
            <div className="mb-3 text-black">{f.icon}</div>
      ...
      <div className="border-t border-gray-100 pt-12">
        <h2 className="text-xs font-bold uppercase tracking-widest text-gray-400 mb-6">Use cases</h2>
      ...
      {/* Audit notice */}
      <div className="mt-16 border border-gray-200 rounded p-4 text-xs text-gray-500">
        <strong className="text-black">⚠ Not audited.</strong>{' '}
